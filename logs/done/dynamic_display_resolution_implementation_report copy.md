...
- Follow-up compile fix from local build log:
  - Fixed `crates/rustyjack-ui/src/app/settings.rs` mixed string literal/`String` array type mismatches in display calibration dialogs.
