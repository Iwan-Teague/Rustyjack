use rustyjack_commands::{
    AntiForensicsCommand, AuditCommand, BridgeCommand, DnsSpoofCommand, EthernetCommand,
...
pub enum Endpoint {
    ...
    ProcessCommand,
    EvasionCommand,
    PhysicalAccessCommand,
    AntiForensicsCommand,
    AuditCommand,
    JobStart,
    JobStatus,
    JobCancel,
...
pub enum RequestBody {
    ...
    PhysicalAccessCommand(PhysicalAccessCommand),
    AntiForensicsCommand(AntiForensicsCommand),
...
pub enum ResponseOk {
    ...
    EvasionCommand(CoreDispatchResponse),
    PhysicalAccessCommand(CoreDispatchResponse),
    AntiForensicsCommand(CoreDispatchResponse),
    AuditCommand(CoreDispatchResponse),
...
pub fn endpoint_for_body(body: &RequestBody) -> Endpoint {
    match body {
        ...
        RequestBody::EvasionCommand(_) => Endpoint::EvasionCommand,
        RequestBody::PhysicalAccessCommand(_) => Endpoint::PhysicalAccessCommand,
        RequestBody::AntiForensicsCommand(_) => Endpoint::AntiForensicsCommand,
        RequestBody::AuditCommand(_) => Endpoint::AuditCommand,
