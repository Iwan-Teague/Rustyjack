...
pub fn required_tier(endpoint: Endpoint) -> AuthorizationTier {
    match endpoint {
        ...
        Endpoint::EvasionCommand => AuthorizationTier::Operator,
        Endpoint::PhysicalAccessCommand => AuthorizationTier::Operator,
        Endpoint::AntiForensicsCommand => AuthorizationTier::Operator,
        Endpoint::AuditCommand => AuthorizationTier::ReadOnly,
