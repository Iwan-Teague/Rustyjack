ARM32 build container (Pi Zero 2 W class on 32-bit Pi OS). This sets up Rust with the armv7 target and the minimal native deps needed for `rustyjack-ui`.
...
Inside the container, build for 32-bit Pi:
```bash
